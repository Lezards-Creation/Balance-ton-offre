...
<template>
      <div class="min-h-full">
            <Navigation />
            <div class="lg:pl-64 flex flex-col p-12">
                  <h1 class="text-3xl font-bold px-12 pb-6 text-fond">Gérer mon profil</h1>
                  <form class="bg-white rounded-lg shadow p-7 space-y-8 divide-y divide-gray-200 ml-12">
                        <div class="space-y-8 divide-y divide-gray-100 sm:space-y-5">
                              <div>
                                    <div>
                                    ...
                                    <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                                          <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-100 sm:pt-5">
                                          ...
                                          <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center sm:border-t sm:border-gray-100 sm:pt-5">
