      ...
      <div class="min-h-full">
            ...
            <div class="lg:pl-64 h-full flex">
                  <div class="flex-1 flex items-stretch overflow-hidden">
                                          ...
                                          <ul role="list" class="grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-3 sm:gap-x-6 md:grid-cols-4 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
                                                <li v-for="file in files" :key="file.name" class="relative">
                                                      <div
                                                            :class="[
                                                                  file.current
                                                                        ? 'ring-2 ring-offset-2 ring-pink-600 shadow-lg shadow-red-200'
                                                                        : 'focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-100 focus-within:ring-pink-600',
                        ...
                        <!-- Details sidebar -->
                        <aside :class="[selected_file ? 'block' : 'hidden', 'w-96 bg-white p-8 border-l border-gray-200 overflow-y-auto h-screen']">
                              <div class="pb-16 space-y-6">
                                    ...
                                    <div>
                                          ...
                                          <dl class="mt-2 border-t border-b border-gray-200 divide-y divide-gray-200">
                                                <div v-for="key in Object.keys(currentFile.information)" :key="key" class="py-2 flex justify-between items-center text-sm font-medium">
