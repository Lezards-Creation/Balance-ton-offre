...
const stats = [
      { name: "Nombre d'offres créées", stat: '71,897', previousStat: '70,946', change: '12%', changeType: 'increase' },
      { name: "Taux d'achèvement", stat: '58.16%', previousStat: '56.14%', change: '2.02%', changeType: 'increase' },
