...
<template>
      <div class="max-h-screen">
            <div class="bg-white rounded-lg p-7 m-5 ml-7 shadow">
                  <h3 class="text-2xl leading-6 font-bold text-gray-900 mb-3">Activité récentes</h3>
                  <ul role="list" class="py-4 h-50vh overflow-y-auto">
